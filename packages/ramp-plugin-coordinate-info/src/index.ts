...
export default class CoordinateInfo {
    ...
    init(api: any) {
        ...
        this.button = this.api.mapI.addPluginButton(
            CoordinateInfo.prototype.translations[this._RV.getCurrentLang()].coordButtonLabel,
    ...
    parseDecli(decli, lang) {
        ...
        const compass =
            decli.compass !== 'useless'
                ? ''
                : CoordinateInfo.prototype.translations[lang].plugin.CoordinateInfo.magCompassOut;

        return { magnetic, annChange, compass };
    }
}

export default interface CoordinateInfo {
    api: any;
    translations: any;
    _RV: any;
    handler: any;
...
CoordinateInfo.prototype.translations = {
    'en-CA': {
